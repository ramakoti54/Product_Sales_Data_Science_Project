...
class Business_Compute:
   ...
   def Standard_Normalized_Sales_Gaussian(self,Data_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i):
      Product_ID = Data_File[0];
      Product_Sales_Volume = Data_File[8];
      Product_Price = Data_File[10];
      Sales_Mean = 0.0;
      ...
      End_Cap_Cost_Mean = np.mean(Product_Cost_End_Cap);
      End_Cap_Cost_Std = np.std(Product_Cost_End_Cap);
      pi = 3.14;  
   
      for i in range(len(Product_ID)):
         if(i < len(Product_ID)):
            Gaussian_Sales.append((1/(math.sqrt(2*pi)*Sales_Std))* math.exp((-1)* math.pow((Product_Sales_Volume[i]-Sales_Mean),2)/(2*math.pow(Sales_Std,2))));
            Gaussian_Cost.append(((1/(math.sqrt(2*pi)*Cost_Std)))* math.exp((-1)* math.pow((Product_Price[i]-Cost_Mean),2)/(2*math.pow(Cost_Std,2))));             
            Gaussian_Aisle_Sales.append(((1/(math.sqrt(2*pi)*Aisle_Sales_Std)))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-Aisle_Sales_Mean),2)/(2*math.pow(Aisle_Sales_Std,2))));            
            Gaussian_Aisle_Cost.append(((1/(math.sqrt(2*pi)*Aisle_Cost_Std)))* math.exp((-1)*math.pow((Product_Price[i]-Aisle_Cost_Mean),2)/(2*math.pow(Aisle_Cost_Std,2))));
            Gaussian_Front_Of_Store_Sales.append(((1/(math.sqrt(2*pi)*Front_Of_Store_Sales_Std)))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-Front_Of_Store_Sales_Mean),2)/(2*math.pow(Front_Of_Store_Sales_Std,2))));
            Gaussian_Front_Of_Store_Cost.append(((1/(math.sqrt(2*pi)*Front_Of_Store_Cost_Std)))* math.exp((-1)*math.pow((Product_Price[i]-Front_Of_Store_Cost_Mean),2)/(2*math.pow(Front_Of_Store_Cost_Std,2))));
            Gaussian_End_Cap_Sales.append(((1/(math.sqrt(2*pi)*End_Cap_Sales_Std)))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-End_Cap_Sales_Mean),2)/(2*math.pow(End_Cap_Sales_Std,2))));                                             
            Gaussian_End_Cap_Cost.append(((1/(math.sqrt(2*pi)*End_Cap_Cost_Std)))* math.exp((-1)*math.pow((Product_Price[i]-End_Cap_Cost_Mean),2)/(2*math.pow(End_Cap_Cost_Std,2))));
         else:
   ...
   def Standard_Normalized_Sales_Gaussian_Avg_Range(self,Data_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i):
      Product_ID = Data_File[0];
      Product_Sales_Volume = Data_File[8];
      Product_Price = Data_File[10];
      Sales_Median = 0.0;
      ...
      Cost_Median = 0.0;
      Cost_Std = 0.0;
      Aisle_Sales_Median = 0.0;
      Aisle_Sales_Std = 0.0;
      Aisle_Cost_Median = 0.0;      
      Aisle_Cost_Std = 0.0;
      Front_Of_Store_Sales_Median = 0.0;
      Front_Of_Store_Sales_Std = 0.0;
      Front_Of_Store_Cost_Median = 0.0;
      Front_Of_Store_Cost_Std = 0.0;
      End_Cap_Sales_Median = 0.0;
      End_Cap_Sales_Std = 0.0;
      End_Cap_Cost_Median = 0.0;
      End_Cap_Cost_Std = 0.0;
      Gaussian_Sales = [];
      Gaussian_Cost = [];
      Gaussian_Aisle_Sales = [];
      ...
      Sales_Avg_Range = (np.min(Product_Sales_List)+np.max(Product_Sales_List))/2.0;
      Sales_Std = np.std(Product_Sales_List);
      Cost_Avg_Range = (np.min(Product_Cost_List)+np.max(Product_Cost_List))/2.0;
      Cost_Std = np.std(Product_Cost_List);
      Aisle_Sales_Avg_Range = (np.min(Product_Sales_Aisle)+np.max(Product_Sales_Aisle))/2.0;
      Aisle_Sales_Std = np.std(Product_Sales_Aisle);
      Aisle_Cost_Avg_Range = (np.min(Product_Cost_Aisle)+np.max(Product_Cost_Aisle))/2.0;
      Aisle_Cost_Std = np.std(Product_Cost_Aisle);
      Front_Of_Store_Sales_Avg_Range = (np.min(Product_Sales_Front_Of_Store)+np.max(Product_Sales_Front_Of_Store))/2.0;
      Front_Of_Store_Sales_Std = np.std(Product_Sales_Front_Of_Store);
      Front_Of_Store_Cost_Avg_Range = (np.min(Product_Cost_Front_Of_Store)+np.max(Product_Cost_Front_Of_Store))/2.0;
      Front_Of_Store_Cost_Std = np.std(Product_Cost_Front_Of_Store);
      End_Cap_Sales_Avg_Range = (np.min(Product_Sales_End_Cap)+np.max(Product_Sales_End_Cap))/2.0;
      End_Cap_Sales_Std = np.std(Product_Sales_End_Cap);
      End_Cap_Cost_Avg_Range = (np.min(Product_Cost_End_Cap)+np.max(Product_Cost_End_Cap))/2.0;
      End_Cap_Cost_Std = np.std(Product_Cost_End_Cap);
      pi = 3.14;  
   
      for i in range(len(Product_ID)):
         if(i < len(Product_ID)):
            Gaussian_Sales.append((1/(math.sqrt(2*pi)*Sales_Std))* math.exp((-1)* math.pow((Product_Sales_Volume[i]-Sales_Avg_Range),2)/(2*math.pow(Sales_Std,2))));
            Gaussian_Cost.append(((1/(math.sqrt(2*pi)*Cost_Std)))* math.exp((-1)* math.pow((Product_Price[i]-Cost_Avg_Range),2)/(2*math.pow(Cost_Std,2))));             
            Gaussian_Aisle_Sales.append(((1/(math.sqrt(2*pi)*Aisle_Sales_Std)))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-Aisle_Sales_Avg_Range),2)/(2*math.pow(Aisle_Sales_Std,2))));            
            Gaussian_Aisle_Cost.append(((1/(math.sqrt(2*pi)*Aisle_Cost_Std)))* math.exp((-1)*math.pow((Product_Price[i]-Aisle_Cost_Avg_Range),2)/(2*math.pow(Aisle_Cost_Std,2))));
            Gaussian_Front_Of_Store_Sales.append(((1/(math.sqrt(2*pi)*Front_Of_Store_Sales_Std)))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-Front_Of_Store_Sales_Avg_Range),2)/(2*math.pow(Front_Of_Store_Sales_Std,2))));
            Gaussian_Front_Of_Store_Cost.append(((1/(math.sqrt(2*pi)*Front_Of_Store_Cost_Std)))* math.exp((-1)*math.pow((Product_Price[i]-Front_Of_Store_Cost_Avg_Range),2)/(2*math.pow(Front_Of_Store_Cost_Std,2))));
            Gaussian_End_Cap_Sales.append(((1/(math.sqrt(2*pi)*End_Cap_Sales_Std)))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-End_Cap_Sales_Avg_Range),2)/(2*math.pow(End_Cap_Sales_Std,2))));                                             
            Gaussian_End_Cap_Cost.append(((1/(math.sqrt(2*pi)*End_Cap_Cost_Std)))* math.exp((-1)*math.pow((Product_Price[i]-End_Cap_Cost_Avg_Range),2)/(2*math.pow(End_Cap_Cost_Std,2))));            
         else:
            return([Gaussian_Sales,Gaussian_Cost,Gaussian_Aisle_Sales,Gaussian_Aisle_Cost,Gaussian_Front_Of_Store_Sales,Gaussian_Front_Of_Store_Cost,Gaussian_End_Cap_Sales,Gaussian_End_Cap_Cost]);
      return([Gaussian_Sales,Gaussian_Cost,Gaussian_Aisle_Sales,Gaussian_Aisle_Cost,Gaussian_Front_Of_Store_Sales,Gaussian_Front_Of_Store_Cost,Gaussian_End_Cap_Sales,Gaussian_End_Cap_Cost]);
   ...
   '''def Standard_Normalized_Sales(self,Data_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i):
      ...
      Sales_Mean = 0;#np.mean(Product_Sales_List);
      Sales_Std = 1;#np.std(Product_Sales_List);
      Cost_Mean = 0;#np.mean(Product_Cost_List);
      Cost_Std = 1;#np.std(Product_Cost_List);
      Aisle_Sales_Mean = 0;#np.mean(Product_Sales_Aisle);
      Aisle_Sales_Std = 1;#np.std(Product_Sales_Aisle);
      Aisle_Cost_Mean = 0;#np.mean(Product_Cost_Aisle);
      Aisle_Cost_Std = 1;#np.std(Product_Cost_Aisle);
      Front_Of_Store_Sales_Mean = 0;#np.mean(Product_Sales_Front_Of_Store);
      Front_Of_Store_Sales_Std = 1;#np.std(Product_Sales_Front_Of_Store);
      Front_Of_Store_Cost_Mean = 0;#np.mean(Product_Cost_Front_Of_Store);
      Front_Of_Store_Cost_Std = 1;#np.std(Product_Cost_Front_Of_Store);
      End_Cap_Sales_Mean = 0;#np.mean(Product_Sales_End_Cap);
      End_Cap_Sales_Std = 1;#np.std(Product_Sales_End_Cap);
      End_Cap_Cost_Mean = 0;#np.mean(Product_Cost_End_Cap);
      End_Cap_Cost_Std = 1;#np.std(Product_Cost_End_Cap);
      pi = 3.14;  
   
      for i in range(len(Product_ID)):
         if(i < len(Product_ID)):
            Gaussian_Sales.append((1/(math.sqrt(2*pi)))* math.exp((-1)* math.pow((Product_Sales_Volume[i]-0),2)/(2*math.pow(Sales_Std,2))));
            Gaussian_Cost.append(((1/(math.sqrt(2*pi))))* math.exp((-1)* math.pow((Product_Price[i]-0),2)/(2*math.pow(Cost_Std,2))));             
            Gaussian_Aisle_Sales.append(((1/(math.sqrt(2*pi))))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-0),2)/(2*math.pow(Aisle_Sales_Std,2))));            
            Gaussian_Aisle_Cost.append(((1/(math.sqrt(2*pi))))* math.exp((-1)*math.pow((Product_Price[i]-0),2)/(2*math.pow(Aisle_Cost_Std,2))));
            Gaussian_Front_Of_Store_Sales.append(((1/(math.sqrt(2*pi))))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-0),2)/(2*math.pow(Front_Of_Store_Sales_Std,2))));
            Gaussian_Front_Of_Store_Cost.append(((1/(math.sqrt(2*pi))))* math.exp((-1)*math.pow((Product_Price[i]-0),2)/(2*math.pow(Front_Of_Store_Cost_Std,2))));
            Gaussian_End_Cap_Sales.append(((1/(math.sqrt(2*pi))))* math.exp((-1)*math.pow((Product_Sales_Volume[i]-0),2)/(2*math.pow(End_Cap_Sales_Std,2))));                                             
            Gaussian_End_Cap_Cost.append(((1/(math.sqrt(2*pi))))* math.exp((-1)*math.pow((Product_Price[i]-0),2)/(2*math.pow(End_Cap_Cost_Std,2))));
         else:
            return([Gaussian_Sales,Gaussian_Cost,Gaussian_Aisle_Sales,Gaussian_Aisle_Cost,Gaussian_Front_Of_Store_Sales,Gaussian_Front_Of_Store_Cost,Gaussian_End_Cap_Sales,Gaussian_End_Cap_Cost]);
      return([Gaussian_Sales,Gaussian_Cost,Gaussian_Aisle_Sales,Gaussian_Aisle_Cost,Gaussian_Front_Of_Store_Sales,Gaussian_Front_Of_Store_Cost,Gaussian_End_Cap_Sales,Gaussian_End_Cap_Cost]);'''
   ...
   def Plot_Histograms(self,Product_Gaussian_Sales,Product_Gaussian_Sales_Aisle,Product_Gaussian_Sales_Front_Of_Store,Product_Gaussian_Sales_End_Cap,Product_Gaussian_Cost,Product_Gaussian_Cost_Aisle,Product_Gaussian_Cost_Front_Of_Store,Product_Gaussian_Cost_End_Cap):
      ...
      n,bins,patches = ax.hist(x,bins=40,density = True,label = "Product Gaussian Sales");
      y = ((1/(np.sqrt(2*pi)*bins))*(np.exp((-1)*math.pow((x-bins),2)/2*math.pow(bins,2))));
      ax.plot(bins,y,'--');
   ...
   def CSV_Reader(self):
      ...
      print("Sales Volume of the Products placed at Aisle stage of the store:\n",np.sum(Product_Sales_Aisle)/len(Product_Sales_Aisle),"Aisle store cloths are Sold for $:\n",np.sum(Product_Cost_Aisle)/len(Product_Sales_Aisle));
      print("Sales Volume of the Products placed at Front side of the store:\n",np.sum(Product_Sales_Front_Of_Store)/len(Product_Sales_Front_Of_Store),"The clothes placed at Front side of the store Sold for $:\n",np.sum(Product_Cost_Front_Of_Store)/len(Product_Sales_Aisle));
      print("Sales Volume of the Products placed at End of the store:\n",np.sum(Product_Sales_End_Cap)/len(Product_Sales_End_Cap),"The clothes placed at Rare side of the store sold for $:\n",np.sum(Product_Cost_End_Cap)/len(Product_Sales_Aisle));
      ...
      Product_Gaussian_Sales = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[0];
      Product_Gaussian_Cost = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[1];
      Product_Gaussian_Sales_Aisle = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[2];
      Product_Gaussian_Cost_Aisle = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[3];
      Product_Gaussian_Sales_Front_Of_Store = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[4];
      Product_Gaussian_Cost_Front_Of_Store = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[5];
      Product_Gaussian_Sales_End_Cap = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[6];
      Product_Gaussian_Cost_End_Cap = self.Standard_Normalized_Sales_Gaussian(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[7];
      ...
      Product_Gaussian_Sales_End_Cap = [];
      Product_Gaussian_Cost_End_Cap = [];
      Product_Gaussian_Sales = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[0];
      Product_Gaussian_Cost = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[1];
      Product_Gaussian_Sales_Aisle = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[2];
      Product_Gaussian_Cost_Aisle = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[3];
      Product_Gaussian_Sales_Front_Of_Store = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[4];
      Product_Gaussian_Cost_Front_Of_Store = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[5];
      Product_Gaussian_Sales_End_Cap = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[6];
      Product_Gaussian_Cost_End_Cap = self.Standard_Normalized_Sales_Gaussian_Avg_Range(Product_Sales_File,Product_Sales_List,Product_Cost_List,Product_Sales_Aisle,Product_Sales_Front_Of_Store,Product_Sales_End_Cap,Product_Cost_Aisle,Product_Cost_Front_Of_Store,Product_Cost_End_Cap,i)[7];
